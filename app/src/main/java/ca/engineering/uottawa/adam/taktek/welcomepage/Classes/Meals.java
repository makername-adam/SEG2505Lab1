public class Meals
{
 ...
 public boolean getOffre()
  ...
  public String toString()
    ...
    return "Le repas " + getNomRepas() + "de type " + getTypeRepas() + "de cuisine" + getTypeCuisine()+ "dont la liste d'ingredients est:" + getListeIngred() +"dont les allergenes sont:" + getAllergenes() + "coute:" + getPrix()+ "a été fait par le cuisinier d'ID:" + getIdcuisinier()+ "est" + o;
  }
}